...
check_token() {  
  echo -e "                                                       "  
  echo -e "${BLUE}[+] =============================================== [+]${NC}"  
  echo -e "${BLUE}[+]               LICENSY Piantechh                 [+]${NC}"  
  echo -e "${BLUE}[+] =============================================== [+]${NC}"  
  echo -e "                                                       "  
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"  
  read -r USER_TOKEN  
  
  if [ "$USER_TOKEN" = "piantech" ]; then  
    echo -e "${GREEN}AKSES BERHASIL${NC}"  
  else  
    echo -e "${GREEN}Buy dulu Gih Ke Piantechh${NC}"  
    echo -e "${YELLOW}TELEGRAM : @Piantechh${NC}"  
    echo -e "${YELLOW}WHATSAPP : 6283120589335${NC}"  
    echo -e "${YELLOW}HARGA TOKEN : 25K FREE UPDATE JIKA ADA TOKEN BARU${NC}"  
    echo -e "${YELLOW}©Piantechh${NC}"  
    exit 1  
  fi  
  clear  
}  
...
if [ -e /root/pterodactyl ]; then  
  ...
  sudo rm -f /root/C1.zip /root/C2.zip /root/C3.zip  
  wget -q -O "$THEME_FILE" "$THEME_URL"  
  sudo unzip -o "$THEME_FILE" -d /root  
...
read -p "Masukkan perintah configure wings (cd /etc/pterodactyl && sudo wings configure ...): " wings  
...
case "$wings" in  
  cd\ /etc/pterodactyl*sudo\ wings\ configure* )  
    ...
    ;;  
  * )  
    echo "Format perintah tidak valid."  
    exit 1  
    ;;  
esac  
...
ubahpw_vps() {  
  ...
  echo -e "${GREEN}[+] =============================================== [+]${NC}"  
  echo -e "                                                       "  
read -p "Masukkan Pw Baru: " pw1  
read -p "Masukkan Ulang Pw Baru: " pw2  
...
while true; do  
  ...
  echo -e "${BLUE}'ggg      ,gg'''  .    ggg       Auto Installer Piantechh Private   ${NC}"  
  echo -e "${BLUE}gggg      gg     ,     ggg      ------------------------  ${NC}"  
  echo -e "${BLUE}ggg:     gg.     -   ,ggg       • Telegram : t.me/Piantechh     ${NC}"  
  echo -e "${BLUE} ggg:     ggg._    _,ggg        • Creadit  : Piantechh ${NC}"  
  echo -e "${BLUE} ggg.    '.'''ggggggp           • Support by Piantechh  ${NC}"  
